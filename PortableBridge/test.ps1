...
$sources = @('PortableBridge.cs', 'FirefoxMaintenance.cs', 'ChromeMaintenance.cs', 'BrowserSupport.cs', 'SessionCoordinator.cs', 'tests\BridgeTests.cs', 'tests\ChromeMaintenanceTests.cs') |
