...
(function () {
    ...
    @font-face {
        font-family: Georgia;
        src: local(Georgia), local('Songti SC'), local('Noto Serif SC');
    }
    ...
    @font-face {
        font-family: Times;
        src: local(Times), local('Songti SC'), local('Noto Serif SC');
    }
    ...
    @font-face {
        ...
        src: local('Times New Roman'), local('Songti SC'), local('Noto Serif SC');
    }
    ...
    @font-face {
        ...
        src: local(-apple-system), local('PingFang SC'), local('Noto Sans SC');
    }
    ...
    @font-face {
        ...
        src: local(Helvetica), local('PingFang SC'), local('Noto Sans SC');
    }
    ...
    @font-face {
        ...
        src: local('helvetica neue'), local('PingFang SC'), local('Noto Sans SC');
    }
    ...
    @font-face {
        ...
        src: local('lucida grande'), local('PingFang SC'), local('Noto Sans SC');
    }
    ...
    @font-face {
        ...
        src: local('Open Sans'), local('PingFang SC'), local('Noto Sans SC');
    }
    ...
    @font-face {
        ...
        src: local('Segoe UI'), local('PingFang SC'), local('Noto Sans SC');
    }
    ...
    @font-face {
        font-family: Tahoma;
        src: local(Tahoma), local('PingFang SC'), local('Noto Sans SC');
    }
    ...
    @font-face {
        font-family: Verdana;
        src: local(Verdana), local('PingFang SC'), local('Noto Sans SC');
    }
